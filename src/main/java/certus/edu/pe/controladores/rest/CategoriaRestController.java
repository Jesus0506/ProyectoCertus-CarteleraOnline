...
import certus.edu.pe.servicios.CategoriaServicios;
...
public class CategoriaRestController {
	...
	public ResponseEntity<Object> buscarTodo()	{
		List<Categoria> listaCategoria = servicio.buscarTodo();
		  ...
		  System.out.println("LISTA DE FUNCIONES : " + listaCategoria);
	...
	public ResponseEntity<Object> buscarPorId(@PathVariable("id") int id) {
		...
		if (categoria == null)
			...
			throw new ResponseStatusException(HttpStatus.NOT_FOUND,
				"Categoria no encontrada,id porporcionado no es correcto");
